                ...
                <div class="layui-card-body ">
                    <table class="layui-table" lay-data="{page:true,toolbar: '#toolbarDemo',id:'test'}" lay-filter="test">
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'id', width:80, sort: true}">卡号</th>
                            <th lay-data="{field:'username', width:120, sort: true, edit: 'text'}">体检人</th>
                            <th lay-data="{field:'email', edit: 'text', minWidth: 150}">时间</th>
                            <th lay-data="{field:'sex', width:80,templet: '#switchTpl'}">性别</th>
                            <th>年龄</th>
                            <th lay-data="{field:'city', edit: 'text', minWidth: 100}">手机</th>
                            <th lay-data="{field:'experience', sort: true, edit: 'text'}">预存金额</th>
                            <th lay-data="{field:'dw_xinzhi',templet: function(d){ return d.dw_xinzhi.titel;}}">套餐</th></tr>
                            <th>套餐</th>
                            <th>项目</th>
                            <th>是否结算</th>
                            <th>操作</th>
